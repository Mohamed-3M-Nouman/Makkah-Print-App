...
function AuthForm() {
  ...
  useEffect(() => {
    if (searchParams.get('registered') === 'true') {
      ...
      // Clear params after showing message to keep URL clean (optional but nice)
      router.replace('/');
    }
  }, [searchParams, router]);
  ...
  return (
    <Card className="w-full max-w-md shadow-2xl border-t-4 border-green-600">
      ...
      <CardContent>
        {successMessage && (
          <div className="mb-4 p-3 bg-green-50 border border-green-100 rounded-xl flex items-center gap-2 text-green-700 animate-in fade-in slide-in-from-top-2">
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-green-50 via-background to-yellow-50">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <Suspense fallback={<Loader2 className="w-8 h-8 animate-spin text-green-600" />}>
          <AuthForm />
        </Suspense>
      </div>
